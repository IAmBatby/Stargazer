...
namespace Stargazer
{
    internal static class Patches
    {
        ...
        internal static StarmapManager visualMoonCatalogue;
        ...
        {
            GameObject visualMoonCatalogueContainerObject = GameObject.Instantiate(Assets.Manifest.StarmapManagerPrefab);
            visualMoonCatalogue = visualMoonCatalogueContainerObject.GetComponent<StarmapManager>();
            ...
            else
            {
                ...
                backingPlane.GetComponent<MeshRenderer>().SetMaterial(Assets.Manifest.BlackMaterial);
            ...
            MoonGroupVisualizer gordionMoonGroupContainer = InstansiateVisualMoonGroupContainer(gordionGroup, Vector2.zero);
            ...
            foreach (MoonGroupVisualizer visualMoonGroup in visualMoonCatalogue.visualMoonGroupContainersList)
            {
                ...
                MoonVisualizer closestVisualMoon = null;
                foreach (MoonVisualizer visualMoon in visualMoonGroup.visualMoonContainersList)
                {
            ...
            foreach (MoonGroupVisualizer visualMoonGroup in visualMoonCatalogue.visualMoonGroupContainersList)
            {
                ...
                foreach (MoonVisualizer visualMoonContainer in visualMoonGroup.visualMoonContainersList)
        ...
        internal static MoonGroupVisualizer InstansiateVisualMoonGroupContainer(ExtendedLevelGroup extendedLevelGroup, Vector2 galaxyOffset)
        {
            string debugString = "Creating Moon Group At: " + galaxyOffset;
            GameObject visualMoonGroupContainerObject = null;
            MoonGroupVisualizer visualMoonGroupContainer = null;

            try
            {
                visualMoonGroupContainerObject = GameObject.Instantiate(Assets.Manifest.MoonGroupVisualizerPrefab, visualMoonCatalogue.transform);
                visualMoonGroupContainer = visualMoonGroupContainerObject.GetComponent<MoonGroupVisualizer>();
                ...
                {
                    MoonVisualizer visualMoonContainer = InstansiateVisualMoonContainer(visualMoonGroupContainer, extendedLevel, galaxyOffset);
        ...
        internal static MoonVisualizer InstansiateVisualMoonContainer(MoonGroupVisualizer visualMoonGroupContainer, ExtendedLevel extendedLevel, Vector2 galaxyOffset)
        {
            string debugString = string.Empty;
            GameObject visualMoonContainerObject;
            MoonVisualizer visualMoonContainer = null;
            debugString += "Starting Initialization Of MoonVisualizer For: " + extendedLevel.SelectableLevel.PlanetName + "\n";
            try
            {
                //Setup Moon
                if (extendedLevel.SelectableLevel.planetPrefab == null)
                    debugString += "No PlanetPrefab Found For: " + extendedLevel.NumberlessPlanetName + "\n";
                else if (extendedLevel.SelectableLevel.planetPrefab.GetComponent<Animator>() == null)
                    debugString += "No PlanetPrefab Animator Found For: " + extendedLevel.NumberlessPlanetName + "\n";
                else if (extendedLevel.SelectableLevel.planetPrefab.GetComponent<MeshRenderer>() == null)
                    debugString += "No PlanetPrefab MeshRenderer Found For: " + extendedLevel.NumberlessPlanetName + "\n";
                else
                {
                    visualMoonContainerObject = GameObject.Instantiate(Assets.Manifest.MoonVisualizerPrefab, visualMoonGroupContainer.transform);
                    visualMoonContainer = visualMoonContainerObject.GetComponent<MoonVisualizer>();
            ...
            debugString += "Ending Initialization.";
            Plugin.DebugLog(debugString);
